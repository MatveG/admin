        ...
        <form @submit.prevent="save" @change="changed" @keyup="stateDraft">
            <div class="columns">
                <div class="column is-two-thirds">
                    ...
                    <card-component title="Фотографии" class="card-top-margin">
                ...
                <div class="column">
                    ...
                    <card-component title="Цена" class="card-top-margin">
...
<!--                                            <div class="button is-static">{{ settings('category', 'currency').sign }}</div>-->
                    ...
                    <card-component v-if="!product.variants.length" title="Наличие" class="card-top-margin">
        ...
        <card-component title="Варианты товара" class="card-top-margin">
  ...
  methods: {
    ...
    async save () {
      ...
      if (this.propId) {
        ...
        const data = await this.$store.dispatch('storeProduct', this.product);
